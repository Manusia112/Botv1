...
*/
const ownerNumber = ["6287720646259@s.whatsapp.net"]
const frendsowner = ["6287832230085@s.whatsapp.net"]
const vip = ["6287720646259@s.whatsapp.net"]
const botName = 'YUKINIKO'
const ownerName = 'DuingZ'
const apiKey = 'Apikey'
